        ...
        <div class="w-6/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input
                        type="password"
                        name="password"  id="password" placeholder="Choose password"
                ...
                <div class="mb-4">
                    ...
                    <input
                        type="password"
                        name="password_confirmation"  id="password" placeholder="Choose password"
                ...
                <div>
                    <button
                        type="submit"
                        class="bg-blue-500 text-white px-5 py-3 rounded font-medium w-full"
                    >
                        Register
                    </button>
                </div>
